...
def handle_command(chat_id, command, message_id=None):
    ...
    if command in ('start', 'main', '/start', 'главное меню', 'привет', 'здравствуй', 'здравствуйте', 'добрый день', 'hello', 'hi'):
        send_message(chat_id,
            ...
            "**💡 Как пользоваться:**\n"
            "**Выберите раздел**👇 или введите **ключевое слово** - сразу получите нужную информацию.\n\n" 
            "✅ Популярные запросы: пожар, спасатели, градусник, огнетушитель, наводнение, цунами, землетрясение, ЕДДС, погода.\n\n"
