...
def handle_command(chat_id, command, message_id=None):
    ...
    elif command in ['sos_points', 'пункты связи', 'пункты экстренной связи', 'экстренная связь', 'терминалы 112', 'где позвонить 112', '112']:
        send_message(chat_id,
            "**📍 ПУНКТЫ ЭКСТРЕННОЙ СВЯЗИ**\n"
            "_Специальные уличные терминалы в Южно-Сахалинске для вызова экстренных служб. "
            "Выручат, если телефон разряжен, сломан или нет связи._\n\n"
            ...
            [
                [btn_link("🗺️ Пункты 112 на Яндекс.Картах", SOS_POINTS_URL)],
                [btn("🏠 Главное меню", 'main')],
            ])
