...
def handle_command(chat_id, command):
    ...
    if command in ['/start', 'start', 'main', 'главное меню']:
        ...
        send_message(chat_id,
            ...
            "📞 **Номера телефонов по муниципальным образованиям:**\n\n"
            "**Александровск-Сахалинский МО:** `8 (42434) 4-44-02`\n"
            "**Анивский МО:** `8 (42441) 4-15-17`\n"
            "**Долинский МО:** `8 (42442) 2-80-00`\n"
            "**Корсаковский МО:** `8 (42435) 4-05-67`\n"
            "**Курильский МО:** `8 (42454) 4-24-47`\n"
            "**Макаровский МО:** `8 (42443) 5-05-13`\n"
            "**Невельский МО:** `8 (42436) 6-09-39`\n"
            "**Ногликский МО:** `8 (42444) 9-71-59`\n"
            "**Охинский МО:** `8 (42437) 5-01-41`\n"
            "**Поронайский МО:** `8 (42431) 4-25-85`\n"
            "**Северо-Курильский МО:** `8 (42453) 2-11-54`\n"
            "**Смирныховский МО:** `8 (42452) 4-26-67`\n"
            "**Томаринский МО:** `8 (42446) 2-62-07`\n"
            "**Тымовский МО:** `8 (42447) 9-10-44`\n"
            "**Углегорский МО:** `8 (42432) 4-48-24`\n"
            "**Холмский МО:** `8 (42433) 2-04-06`\n"
            "**Южно-Курильский МО:** `8 (42455) 2-26-87`\n"
            "**Город Южно-Сахалинск:** `112`\n\n"
            "⚠️ **В случае угрозы жизни звоните `112`**",
            back_menu())
